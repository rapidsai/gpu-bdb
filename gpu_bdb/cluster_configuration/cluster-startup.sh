...
LOCAL_DIRECTORY=${LOCAL_DIRECTORY:-/raid/shondacet/dask-local-directory}
SCHEDULER_FILE=${SCHEDULER_FILE:-$LOCAL_DIRECTORY/scheduler.json}
LOGDIR=${LOGDIR:-/home/$USERNAME/logs}
WORKER_DIR=${WORKER_DIR:-/raid/shondacet/gpu-bdb-dask-workers/}
...
CONDA_ENV_NAME=${CONDA_ENV_NAME:-updated_gpu_bdb}
CONDA_ENV_PATH=${CONDA_ENV_PATH:-/home/$USERNAME/miniconda3/etc/profile.d/conda.sh}

# Repository home
GPU_BDB_HOME=${GPU_BDB_HOME:-/home/$USERNAME/gpu-bdb}
